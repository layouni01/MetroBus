...
const EditProfile = () => {
    ...
    const [profilePic, setProfilePic] = useState('https://scontent.ftun7-1.fna.fbcdn.net/v/t1.6435-9/143042343_1895477503933256_1687614422400570660_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=5f2048&_nc_ohc=VPugG3iGJS4AX_9ZiMB&_nc_ht=scontent.ftun7-1.fna&oh=00_AfDuQ0bvnN9wrpPj-MwEeLdDJAHQg9j-1IVBHxNfHP71VA&oe=6627B346');
            ...
            <ScrollView>
                <View style={styles.header}>
                    <HeaderBackButton
                        ...
                        onPress={goBack} />
                    <Text style={styles.texth} >Edit Profile</Text>
                </View>
